...
## See how a photo changes the answer (0:00-0:50)
...
## Pick a job you keep repeating (0:50-1:20)
...
## Ask AI to help you build it (1:20-1:50)
...
## Connect the models with code (1:50-2:20)
...
## Pair each example with an answer (2:50-3:25)
...
## Train it using checked examples (3:25-3:55)
...
## Test it on examples it hasn't seen (3:55-4:25)
...
## Look at an answer it got wrong (4:25-4:55)
...
## Compare its answers with Jev's (4:55-5:25)
...
## Add a model that reads images (5:25-6:00)
...
## Check what the photo can tell you (6:00-6:30)
...
## Check each person's requirements (6:30-7:00)
...
## Work out what it costs to run (8:10-8:40)
